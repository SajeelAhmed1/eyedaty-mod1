    ...
    <section className="text-gray-600 px-10   body-font">
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                ...
                <h1 className="text-7xl sm:text-4xl  mb-4 font-extrabold text-gray-900">Notre services Nous fournissons les meilleurs services</h1>
                <p className="mb-8 leading-relaxed">Lörem ipsum prektigt beren makroligt, till desena. Lasock heterok. Nir nist så keltisk tiger usat fast bior. Rebel nedyn prertad krod semigon. Rest reska inte eubel sasade. Du kan vara drabbad. 
Ananade krogogt fulparkerare. Speskade syll men polylunat biortad. Hell dede. Kasa keredybär.</p>
            </div>
        ...
        <div className=' w-3/4 space-y-5 my-5'>
            <div className='w-full flex justify-center '>
                <div className='bg-sitegreen w-4/6 p-8 rounded-xl text-white flex flex-row'>
