...
export default function Tandc() {
  return (
    ...
    <div className='flex w-full justify-center items-center flex-col space-y-5 my-10'>
        ...
        <div className='flex w-full justify-start flex-col lg:px-20 px-10 space-y-5'>
        <p>
            ...
            <div>
                <p>
                You may consult this list to find the Privacy Policy for each of the advertising partners of rosaliss.
